...
namespace ResponsiPemrograman4331
{
    class Program
    {
        ...
        {
            Karyawan karyawan1 = new Karyawan(150003, "wawan", 6000000);
            Karyawan karyawan2 = new Karyawan(150004, "gunawan", 5000000);
            Karyawan karyawan3 = new Karyawan(150005, "jenggot", -200000);
